...
<center>   
    ...
    <a  class="btn btn-success" href="home.php?pg=icus" style="margin-top: -18px; margin-left: 90%;">Add Customer</a>
...
{
    $count = $count+1;
    echo '<tr><td>'.$count.'</td><td>'.$value['cus_name'].'</td><td>'.$value['cus_address'].'</td><td>'.$value['cus_contact'].'</td><td>'.$value['cus_cnic'].'</td>';
