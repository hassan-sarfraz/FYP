...
<!--                                                    <div class="pull-right">
					...
					<!-- Main Header -->
					<div id="main-header" class="style1">
			...
			<div class="row content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                	<div class="breadcrumbs">
                    	<p><a href="#">Home</a> <i class="icons icon-right-dir"></i> Air Conditioner &amp; Generators</p>
                    </div>
                </div>
                    ...
                    <div class="row">
						...
						<div class="col-lg-12 col-md-12 col-sm-12">
							...
							<div class="carousel-heading">
								<h4>Air Conditioner &amp; Generators</h4>
							</div>
...
<!--                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="row subcategories">
                                ...
                                <div class="col-lg-fifth col-md-fifth col-sm-fifth subcategory">
                                    ...
                                    <a href="#"><img style="height: 166px;" src="img/slide_4.jpg" alt="Product1"></a>
                                ...
                                <div class="col-lg-fifth col-md-fifth col-sm-fifth subcategory">
                                    ...
                                    <a href="#"><img style="height: 166px;" src="img/slide_5.jpg" alt="Product1"></a>
                                    <div class="product-info">
                                        <h6><a href="#">Lorem ipsum dolor sit amet</a></h6>
                                    </div>
                                ...
                                <div class="col-lg-fifth col-md-fifth col-sm-fifth subcategory">
                                    ...
                                    <a href="#"><img style="height: 166px;" src="img/slide_3.jpg" alt="Product1"></a>
                                    <div class="product-info">
                                        <h6><a href="#">Lorem ipsum dolor sit amet</a></h6>
                                    </div>
                                ...
                                <div class="col-lg-fifth col-md-fifth col-sm-fifth subcategory">
                                    ...
                                    <a href="#"><img style="height: 166px;" src="img/slide_1.jpg" alt="Product1"></a>
                                    <div class="product-info">
                                        <h6><a href="#">Lorem ipsum dolor sit amet</a></h6>
                                    </div>
...
<!--                        <div class="col-lg-6 col-md-6 col-sm-6">
                   ...
                   <div class="row"> 
                        <!-- Product Item -->
                         <?php
include 'connection.php';$temp=7;
$query = "select * from product,product_category where product.pcat_id=product_category.pcat_id and product.pcat_id=$temp";
...
{?>
                        <div class="col-lg-4 col-md-4 col-sm-4 product">
                            ...
                            <div class="product-image">
                                <img style="-webkit-transform: scale(1.0);" src="<?php echo $value['image']?>" alt="Product1" height="270">
                                <a <?php echo " href='products_page_v1.php?id=".$value['p_id']."'"?> class="product-hover">
				<i class="icons icon-eye-1"></i> Quick View
                            ...
                            <div style="height: 117px;" class="product-info">
                                ...
                                <span class="price">Rs.<?php echo $value['p_price']?>.00</span>
...
<!--                        <div class="col-lg-4 col-md-4 col-sm-4 product">
                            ...
                            <div class="product-image">
                                <img style="-webkit-transform: scale(1.0);" src="img/products/c_2.jpg" alt="Product1" height="270">
				...
				<i class="icons icon-eye-1"></i> Quick View
                            ...
                            <div style="height: 117px;" class="product-info">
                                <h5>Canon EOS 7D DSLR Camera</h5>
                                <span class="price">Rs.80,000.00</span>
                                <div class="rating readonly-rating" data-score="4"></div>
                            </div>-->
...
<!--                        <div class="col-lg-4 col-md-4 col-sm-4 product">
                            ...
                            <div class="product-image">
                                <img style="-webkit-transform: scale(1.0);" src="img/products/c3.jpg" alt="Product1" height="270">
                                <a href="products_page_v1.html" class="product-hover">
				<i class="icons icon-eye-1"></i> Quick View
				</a>
                            </div>
...
<!--                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 product">
                            ...
                            <div class="product-image">
                                <img style="-webkit-transform: scale(1.0);" src="img/products/n1.jpg" alt="Product1" height="270">
                                <a href="products_page_v1.html" class="product-hover">
				<i class="icons icon-eye-1"></i> Quick View
				</a>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 product">
                            ...
                            <div class="product-image">
                                <img style="-webkit-transform: scale(1.0);" src="img/products/n2.jpg" alt="Product1" height="270">
                                <a href="products_page_v1.html" class="product-hover">
				<i class="icons icon-eye-1"></i> Quick View
				</a>
                            </div>
                            ...
                            <div style="height: 117px;" class="product-info">
                                <h5>Nikon D610 DSLR Camera</h5>
                                <span class="price">Rs.48,500.00</span>
                                <div class="rating readonly-rating" data-score="4"></div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 product">
                            ...
                            <div class="product-image">
                                <img style="-webkit-transform: scale(1.0);" src="img/products/n3.jpg" alt="Product1" height="270">
                                <a href="products_page_v1.html" class="product-hover">
				<i class="icons icon-eye-1"></i> Quick View
				</a>
                            </div>
                            ...
                            <div style="height: 117px;" class="product-info">
                                <h5>Nikon D700 DSLR Camera</h5>
                                <span class="price">Rs.50,000.00</span>
                                <div class="rating readonly-rating" data-score="4"></div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 product">
                            ...
                            <div class="product-image">
                                <img style="-webkit-transform: scale(1.0);" src="img/products/s1.jpg" alt="Product1" height="270">
                                <a href="products_page_v1.html" class="product-hover">
				<i class="icons icon-eye-1"></i> Quick View
				</a>
                            </div>
                            ...
                            <div style="height: 117px;" class="product-info">
                                <h5>Sony Alpha A3000 DSLR Camera</h5>
                                <span class="price">Rs.33,000.00</span>
                                <div class="rating readonly-rating" data-score="4"></div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 product">
                            ...
                            <div class="product-image">
                                <img style="-webkit-transform: scale(1.0);" src="img/products/s2.jpg" alt="Product1" height="270">
                                <a href="products_page_v1.html" class="product-hover">
				<i class="icons icon-eye-1"></i> Quick View
				</a>
                            </div>
                            ...
                            <div style="height: 117px;" class="product-info">
                                <h5>Sony Alpha A3500 With 16-50mm F2.8 lens DSLR Camera</h5>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 product">
                            ...
                            <div class="product-image">
                                <img style="-webkit-transform: scale(1.0);" src="img/products/s3.jpg" alt="Product1" height="270">
                                <a href="products_page_v1.html" class="product-hover">
				<i class="icons icon-eye-1"></i> Quick View
				</a>
                            </div>
                            ...
                            <div style="height: 117px;" class="product-info">
                                <h5>Sony A77 24.3 MP Translucent Mirror Digital SLR Camera</h5>
                                <span class="price">Rs.49,500.00</span>
                                <div class="rating readonly-rating" data-score="4"></div>
                            </div>
					...
					<div class="row sidebar-box">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 sidebar-carousel">
							...
							<section class="sidebar-slider">
									...
									<ul class="slides">
										<li>
                                                                                    <a href="#"><img src="img/image_1.png" alt="Slide1"/></a>
										</li>
										<li>
                                                                                    <a href="#"><img src="img/image_2.jpg" alt="Slide1"/></a>
										</li>
										<li>
                                                                                    <a href="#"><img src="img/image_3.jpg" alt="Slide1"/></a>
										</li>
									</ul>
								</div>
