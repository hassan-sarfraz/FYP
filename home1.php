                    ...
                    <div id="top-header">
                        ...
                        <div class="row">
                            ...
                            <nav id="top-navigation" class="col-lg-7 col-md-7 col-sm-7">
                                <ul class="pull-left">
                                    <li><a href="create_an_account.html">Employee Login</a></li>
                            ...
                            <nav class="col-lg-5 col-md-5 col-sm-5">
                                <ul class="pull-right">
                                    <li class="purple"><a href="#"><i class="icons icon-user-3"></i>Admin Login</a>
                                        <ul id="login-dropdown" class="box-dropdown">
                                            <li>
                                                <div class="box-wrapper">
                                                    <form action="vlog.php">
                                                        <h4>LOGIN</h4>
                    ...
                    <div id="main-header">
                        ...
                        <div class="row">
                            ...
                            <div id="logo" class="col-lg-4 col-md-4 col-sm-4">
                                <a href="home1.php"><img src="img/logo_1.png" alt="Logo"></a>
                            </div>
                                                                                ...
                                                                                <table class="language-table">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="country"><a href="#">Spanish</a></td>
                                                                                                    ...
                                                                                                    <li><a href="#"><i class="icons icon-th-3"></i>PKR</a>
                                                                    <ul class="box-dropdown parent-arrow">
                                                                                                                    <li>
                                                                            <div class="box-wrapper no-padding parent-border">
            ...
            <div class="row content">
                ...
                <section class="main-content col-lg-9 col-md-9 col-sm-9 col-lg-push-3 col-md-push-3 col-sm-push-3">
                            ...
                            <div class="tp-banner" >
                                <ul>
                                    ...
                                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                                        <!-- MAIN IMAGE -->
                                        <img src="img/slide_2.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                                        <!-- LAYERS -->
                                        <div class="tp-caption skewfromrightshort fadeout"
                                             ...
                                             data-speed="500"
                                             data-start="1200"
                                             data-easing="Power4.easeOut"><h2><strong>Canon</strong> see Impossible</h2>
                                        </div>
                                        <div class="tp-caption skewfromrightshort fadeout"
                                             data-x="40"
                                             data-y="140"
                                        ...
                                        <div class="tp-caption skewfromrightshort fadeout"
                                             ...
                                             data-speed="500"
                                             data-start="1200"
                                             data-easing="Power4.easeOut"><span>From <span class="price">Rs.45,500.00</span></span>
                                        </div>
                                        <div class="tp-caption skewfromrightshort fadeout"
                                             data-x="40"
                                             data-y="300"
                                    ...
                                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" >
                                        <!-- MAIN IMAGE -->
                                        <img src="img/slide_3.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                                        <!-- LAYERS -->
                                        <div class="tp-caption skewfromrightshort fadeout"
                                             data-x="40"
                                             data-y="60"
                                        ...
                                        <div class="tp-caption skewfromrightshort fadeout"
                                             ...
                                             data-speed="500"
                                             data-start="1200"
                                             data-easing="Power4.easeOut"><span>Only <span class="price">Rs.5,900.00</span></span>
                                        </div>
                                        <div class="tp-caption skewfromrightshort fadeout"
                                             data-x="40"
                                             data-y="347"
                                    ...
                                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" >
                                        <!-- MAIN IMAGE -->
                                        <img src="img/slide_1.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                                        <!-- LAYERS -->
                                        <div class="tp-caption skewfromrightshort fadeout"
                                             data-x="40"
                                             data-y="60"
                                        ...
                                        <div class="tp-caption skewfromrightshort fadeout"
                                             ...
                                             data-speed="500"
                                             data-start="1200"
                                             data-easing="Power4.easeOut"><span>From <span class="price">Rs.62,000.00</span></span>
                                        </div>
                                        <div class="tp-caption skewfromrightshort fadeout"
                                             data-x="40"
                                             data-y="300"
                    ...
                    <div class="products-row row">
                        ...
                        <!-- Carousel Heading -->
                        <div id="featurepro" class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/lappi.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>

                                        <div style="height: 117px;" class="product-info">
                                            <h5>Lenovo Ideapad 310 15.6" Laptop</h5>
                                            <span class="price">Rs.40,000.00</span>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            ...
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/camera.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                        ...
                                        <div style="height: 117px;" class="product-info">
                                            <h5>Canon 1200D</h5>
                                            <span class="price">Rs.30,000.00</span>
                                            <!--<div class="rating readonly-rating" data-score="4"></div>-->
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/fan.jpg" style="height: 270px;" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                        ...
                                        <div style="height: 117px;" class="product-info">
                                            <h5>Anchor XL Ceilng Fan White</h5>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/led.jpg"  alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                        ...
                                        <div style="height: 117px;" class="product-info">
                                            <h5>SONY 48" LED INTERNET TV</h5>
                                            <span class="price">Rs.56,000.00</span>
                                            <!--<div class="rating readonly-rating" data-score="4"></div>-->
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/washing machine.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                        ...
                                        <div style="height: 117px;" class="product-info">
                                            <h5>Kenwood Washing Machine</h5>
                                            <span class="price">Rs.55,000.00</span>
                                            <!--<div class="rating readonly-rating" data-score="4"></div>-->
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/mobile.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                        ...
                                        <div style="height: 117px;" class="product-info">
                                            <h5>Samsung Galaxy S6 Edge</h5>
                                            <span class="price">Rs.59,000.00</span>
                                            <!--<div class="rating readonly-rating" data-score="4"></div>-->
                                        </div>
                    ...
                    <div class="products-row row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div id="newcollection" class="carousel-heading">
                            ...
                            <div class="owl-carousel" data-max-items="3">
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <span class="product-tag">Sale</span>
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/ac2.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/son1.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/d1.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/ecoled3.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/hp2.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/n3.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                            ...
                            <div class="owl-carousel" data-max-items="3">
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/r1.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/sonyled3.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/sonyht2.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
...
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/fan.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/gen3.jpg" alt="Product1">
<!--                                            <a href="products_page_v1.html" class="product-hover">
                                                <i class="icons icon-eye-1"></i> Quick View
                                            </a>-->
                                        </div>
                    ...
                    <div class="products-row row">
                        ...
                        <div class="carousel owl-carousel-wrap col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="owl-carousel">
                                ...
                                <div>
                                    <div class="product">
                                        <a href="#"><img src="img/brands/samsung.png" alt="Brand1"></a>
                                    </div>
                                </div>
                                <!-- /Slide -->
                                ...
                                <div>
                                    <div class="product">
                                        <a href="#"><img src="img/brands/asia.gif" alt="Brand1"></a>
                                    </div>
                                </div>
                                <!-- /Slide -->
                                ...
                                <div>
                                    <div class="product">
                                        <a href="#"><img src="img/brands/qmobile.png" alt="Brand1"></a>
                                    </div>
                                </div>
                                <!-- /Slide -->
                                ...
                                <div>
                                    <div class="product">
                                        <a href="#"><img src="img/brands/sony.png" alt="Brand1"></a>
                                    </div>
                                </div>
                                <!-- /Slide -->
                                ...
                                <div>
                                    <div class="product">
                                        <a href="#"><img src="img/brands/lenovo.png" alt="Brand1"></a>
                                    </div>
                                </div>
                                <!-- /Slide -->
                                ...
                                <div>
                                    <div class="product">
                                        <a href="#"><img src="img/brands/gree.png" alt="Brand1"></a>
                                    </div>
                                </div>
                                <!-- /Slide -->
                                ...
                                <div>
                                    <div class="product">
                                        <a href="#"><img src="img/brands/haier.png" alt="Brand1"></a>
                                    </div>
                                </div>
                                <!-- /Slide -->
                                ...
                                <div>
                                    <div class="product">
                                        <a href="#"><img src="img/brands/ecostar.jpg" alt="Brand1"></a>
                                    </div>
                                </div>
                                <!-- /Slide -->
                                ...
                                <div>
                                    <div class="product">
                                        <a href="#"><img src="img/brands/orient.jpg" alt="Brand1"></a>
                                    </div>
                                </div>
                                <!-- /Slide -->
                ...
                <aside class="sidebar col-lg-3 col-md-3 col-sm-3  col-lg-pull-9 col-md-pull-9 col-sm-pull-9">
                    ...
                    <div class="row sidebar-box purple">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="sidebar-box-content">
                                <ul>
                                    <li><a href="category_v1.php">Cameras &amp; Photography <i class="icons icon-right-dir"></i></a></li>
                                    <li><a href="category_v1_1.php">Computers &amp; Tablets <i class="icons icon-right-dir"></i></a></li>
                                    <li><a href="category_v1_2.php">Cell Phones &amp; Accessories <i class="icons icon-right-dir"></i></a></li>
                                    <li><a href="category_v1_3.php">LCD, LED &amp; Home Theatre <i class="icons icon-right-dir"></i></a></li>
                                    <li><a href="category_v1_4.php">Refrigerator &amp; Dispenser  <i class="icons icon-right-dir"></i></a></li>
                                    <li><a href="category_v1_5.php">Air Conditioner &amp; Generators <i class="icons icon-right-dir"></i></a></li>
                                    <li><a href="category_v1_6.php">Air Cooler &amp; Fans <i class="icons icon-right-dir"></i></a></li>
                                    <li><a href="category_v1_7.php">Kitchen Appliances <i class="icons icon-right-dir"></i></a></li>
                                    <li><a class="purple" href="category_v1_8.php">All Categories</a></li>
                                </ul>
                            </div>
                    ...
                    <div class="row sidebar-box red">
                        ...
                        <div id="bestseller" class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div  class="sidebar-box-content">
                                <table class="bestsellers-table">
                                    ...
                                    <tr>
                                        <td><img src="img/brands/ecostar.jpg" alt="Product1"></td>
                                        <td><img src="img/brands/gree.png" alt="Product1">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td><img src="img/brands/samsung.png" alt="Product1"></td>
                                        <td><img src="img/brands/orient.jpg" alt="Product1">
                                        </td>
                                    </tr>

                                    <tr>
                                        <td><img src="img/brands/lenovo.png" alt="Product1"></td>
                                        <td><img src="img/brands/qmobile.png" alt="Product1">
                                        </td>
                                    </tr>
                    ...
                    <div class="row sidebar-box green">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="sidebar-box-content sidebar-padding-box">
                                ...
                                <a href="#" class="tag-item">home theatre</a>
                                <a href="#" class="tag-item">air conditioner</a>
                                <a href="#" class="tag-item">headphones</a>
                                <a href="#" class="tag-item">refrigerator</a>
                                <a href="#" class="tag-item">laptop</a>
                                <a href="#" class="tag-item">smartphone</a>
                                <a href="#" class="tag-item">led</a>
                            </div>
                            ...
                            <div class="owl-carousel" data-max-items="1">
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/sam3.jpg" alt="Product1">
                                            <!--											<a href="products_page_v1.html" class="product-hover">
                                                                                                                                            <i class="icons icon-eye-1"></i> Quick View
                                                                                                                                    </a>-->
                                        </div>

                                        <div style="height: 94px;" class="product-info">
                                            <h5>Samsung Galaxy S8 Arctic Silver</h5>
                                            <span class="price">Rs.86,999.00</span>
                                            <!--<div class="rating readonly-rating" data-score="4"></div>-->
                                        </div>
                                ...
                                <div>
                                    ...
                                    <div class="product">
                                        ...
                                        <div class="product-image">
                                            <img style="-webkit-transform: scale(1.0);" src="img/products/c3.jpg" alt="Product1">
                                            <!--											<a href="products_page_v1.html" class="product-hover">
                                                                                                                                            <i class="icons icon-eye-1"></i> Quick View
                                                                                                                                    </a>-->
                                        </div>
                                        ...
                                        <div style="height: 94px;" class="product-info">
                                            <h5>Canon EOS 5Ds R DSLR Camera</h5>
                                            <span class="price">Rs.65,999.00</span>
                                            <!--<div class="rating readonly-rating" data-score="4"></div>-->
                                        </div>
                    ...
                    <div id="main-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 facebook-iframe">
                                ...
                                <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FAfzal-group-of-electronics-555032607929758%2F&tabs=timeline&width=340&height=290px&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="340" height="290px" style="border:none; overflow:hidden; width:100%; height:290px;"></iframe>
<!--								<iframe src="//www.facebook.com/plugins/likebox.php?href=http%3A%2F%2Fwww.facebook.com%2FFacebookDevelopers&amp;width=270&amp;height=250&amp;colorscheme=light&amp;header=false&amp;show_faces=true&amp;stream=false&amp;show_border=false" style="border:none; overflow:hidden; width:100%; height:290px;"></iframe>-->
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#newcollection"><i class="icons icon-right-dir"></i> New Collection</a></li>
                                    <li><a href="#bestseller"><i class="icons icon-right-dir"></i> Bestsellers</a></li>
                                    <li><a href="#featurepro"><i class="icons icon-right-dir"></i> Featured Products</a></li>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 contact-footer-info">
                                <h4>Contact Us</h4>
                                <ul>
                                    <li><i class="icons icon-location"></i>  <p>Gulshan Market Rd,<br>

                                            Multan,Pakistan</p></li>
                                    <li><i class="icons icon-phone"></i>111 - 615 - 324</li>
                                    <li><i class="icons icon-mail-alt"></i><a href="mailto:mail@company.com">info@afzalelectronics.com</a></li>
                                    <li><i class="icons icon-skype"></i> afzal_electronics</li>
                                </ul>
                            </div>
                            <!-- /Contact Us -->
