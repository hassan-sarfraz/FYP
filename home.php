					...
					<!-- Main Header -->
						...
						<div class="row">
							...
							<div id="logo" class="col-lg-4 col-md-4 col-sm-4">
                                                            <a href="mainhome.php"><img src="img/logo_1.png" alt="Logo"></a>
							</div>
     ...
     switch ($pg)
     {
         case 'disbr':
            ...
            case 'discus':
                ...
                break;
            case 'icus':
                include 'insert_customer_form.php';
                break;
            case 'ecus':
            ...
            case 'disca':
                include 'display_customer_account.php';
                break;
            case 'ica':
                include 'insert_customer_account_form.php';
                break;
            case 'eca':
            ...
            case 'disemp':
                ...
                break;
            case 'iemp':
                include 'insert_employee_form.php';
                break;
            case 'eemp':
            ...
            case 'disim':
                include 'display_installment_mode.php';
                break;
            case 'iim':
                include 'insert_installment_mode_form.php';
                break;
            case 'eim':
            ...
            case 'dispc':
                include 'display_product_category.php';
                break;
            case 'ipc':
                include 'insert_product_category_form.php';
                break;
            case 'epc':
            ...
            case 'dispd':
                include 'display_purchase_detail.php';
                break;
            case 'ipd':
                include 'insert_purchase_detail_form.php';
                break;
            case 'epd':
            ...
            case 'dispo':
                include 'display_purchase_order.php';
                break;
            case 'ipo':
                include 'insert_purchase_order_form.php';
                break;
            case 'epo':
            ...
            case 'dissd':
                include 'display_sales_detail.php';
                break;
            case 'isd':
                include 'insert_sales_detail_form.php';
                break;
            case 'esd':
            ...
            case 'disst':
                include 'display_stock.php';
                break;
            case 'ist':
                include 'insert_stock_form.php';
                break;
            case 'est':
            ...
            case 'dissup':
                include 'display_supplier.php';
                break;
            case 'isup':
                include 'insert_supplier_form.php';
                break;
            case 'esup':
            ...
            case 'diswit':
                include 'display_witness.php';
                break;
            case 'iwit':
                include 'insert_witness_form.php';
                break;
            case 'ewit':
