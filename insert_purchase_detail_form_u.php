...
<center>
    ...
    <form name="insert_purchase_detail_form_u" method="post" action="insert_purchase_detail_u.php" style="width: 100%;">
    ...
    <tr>
        <td  style="width:40%"><label>PURCHASE ORDER NO:</label></td>
        <td><select class="form-control" style="width: 100%" name="orderno"><br>
