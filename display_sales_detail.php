...
<center>   
    ...
    <a  class="btn btn-success" href="home.php?pg=isd" style="margin-top: -18px; margin-left: 89%;">Add Sales Detail</a>
    ...
    {
        $count=$count+1;
        echo '<td>'.$value['sd_id'].'</td><td>'.$value['date'].'</td><td>'.$value['qty'].'</td><td>'.$value['cus_name'].'</td><td>'.$value['p_name'].'</td><td>'.$value['mode_title'].'</td>';
