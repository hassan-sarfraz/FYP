			...
			<div class="row content">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                	<div class="breadcrumbs">
                    	<p><a href="#">Home</a> <i class="icons icon-right-dir"></i>All Categories</p>
                    </div>
                </div>
...
//$temp=9;
$query = "select * from product,product_category where product.pcat_id=product_category.pcat_id";
