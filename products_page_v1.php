...
$query = "select * from product,product_category,brand where product.pcat_id=product_category.pcat_id and product.br_id=brand.br_id and p_id=$var";
...
foreach ($result as $value)
{
    ...
    $cat_id=$value['pcat_id'];
    $br_id=$value['br_id'];
    $image=$value['image'];
    
    $query1="select * from product_category where pcat_id=$cat_id";
    $result1=  mysqli_query($link, $query1);
    foreach ($result1 as $value1)
    {
        $cat_name=$value1['pcat_name'];
    }
    $query2="select * from brand where br_id=$br_id";
    $result2=  mysqli_query($link, $query2);
    foreach ($result2 as $value2)
    {
        $br_name=$value2['br_name'];
    }
}
?>
						<!-- Product -->
							...
							<div class="row">
								...
								<div class="col-lg-5 col-md-5 col-sm-5 product-single-image">
									...
									<div id="product-slider">
										<!--<ul class="slides">-->
											<!--<li>-->
                                                                                        <img src="<?php echo $image;?>" data-large="" alt="" />
...
<!--									<div id="product-carousel">
										<ul class="slides">
											<li>
                                                                                            ...
                                                                                            <img src="" data-large="" alt=""/>
											</li>
											<li>
												<a class="fancybox" rel="product-images" href="img/slide_1.jpg"></a>
												<img src="img/slide_1.jpg" data-large="img/slide_1.jpg" alt="" />
											</li>
											<li>
...
<!--									<div class="rating-box">
										...
										<tr>
											<td>Category:</td>
                                                                                        <td><a href="#"><?php echo $cat_name; ?></a></td>
										</tr>
                                                                               
										<tr>
											<td>Brand:</td>
                                                                                        <td><a href="#"><?php echo $br_name; ?></a></td>
										</tr>
										<tr>
											<td>Net Price:</td>
...
<!--                                                                                <tr>
											...
											<td>Rs.3,335.00</td>
                                                                        ...
                                                                        <table>
                                                                            <tr>
											<thead><b>Description:</b></thead><br><br>
