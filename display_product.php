...
<center>   
        ...
        <div>
        <a  class="btn btn-warning" style="margin-bottom: -110px; width: 8%;" href="sample1.php" target="_blank">Print</a> 
        </div>
        <a  class="btn btn-success" href="home.php?pg=ipro" style="margin-top: -18px; margin-left: 91%;">Add Product</a> 
