...
<center>   
    ...
    <a  class="btn btn-success" href="main_home_of_user.php?pg=ica" style="margin-top: -18px; margin-left: 85.5%;">Add Customer Account</a>
...
{
    $count = $count+1;
    echo '<tr><td>'.$value['account_id'].'</td><td>'.$value['cus_name'].'</td><td>'.$value['total_amount'].'</td><td>'.$value['amount_recieved'].'</td><td>'.$value['remaining'].'</td</td>';
